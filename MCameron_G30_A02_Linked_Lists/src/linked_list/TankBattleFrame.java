...
public class TankBattleFrame extends JFrame implements ActionListener {
	...
	private JPanel createTitlePanel() {
		backgroundImage = new ImageIcon("Background_Title.jpg").getImage();
		...
		lblTitleImage = new JLabel("TANK BATTLE");
		lblTitleImage.setForeground(new Color(255, 255, 255));
		lblTitleImage.setFont(new Font("Arial", Font.PLAIN, 96));

		lblTankImage = new JLabel(new ImageIcon("Tank.jpg"));
		...
		titlePanel.add(lblTitleImage, "cell 0 0,alignx center,aligny center");
	...
	private JPanel createLoadPanel() {
		...
		backgroundImage = new ImageIcon("Background_Load.jpg").getImage();
		...
		btnPlay.setFont(new Font("Arial", Font.PLAIN, 25));
		btnPlay.addActionListener(this);

		loadPanel.setLayout(new MigLayout("", "[1280.00,grow,right]", "[][][][][][][][]"));
		loadPanel.add(lblTitleImage, "cell 0 0,alignx center");
		...
		loadPanel.add(fldName, "cell 0 6,alignx center");
		loadPanel.add(btnPlay, "cell 0 7,alignx center");
		return loadPanel;
	}
	...
	private JPanel createGamePanel() {
		...
		setMenu();
		contentPanel.removeAll();
		backgroundImage = new ImageIcon("Background_Game.jpg").getImage();
		...
		lblHPBarBlue.setIcon(new ImageIcon("HPBar_6.png"));
		lblHPBarBlue.setForeground(Color.white);

		lblHPBarRed = new JLabel("");
		lblHPBarRed.setIcon(new ImageIcon("HPBar_6.png"));
		lblHPBarRed.setForeground(Color.white);

		lblBlue = new JLabel(new ImageIcon("Blue/Blue_6_0.png"));

		lblRed = new JLabel(new ImageIcon("Red.png"));

		gamePanel.setLayout(new MigLayout("", "[30][300][620][30][300]", "[][][][][][][][][]"));
		...
		gamePanel.add(lblTitleImage, "cell 0 0 5 1,alignx center,aligny center");
	...
	private void changeHPBars(int blue, int red) {

		ImageIcon HPBar = new ImageIcon("HPBars/HPBar_" + blue + ".png");
		lblHPBarBlue.setIcon(HPBar);
		if (red >= 6)
			HPBar = new ImageIcon("HPBars/HPBar_6.png");
		else
			HPBar = new ImageIcon("HPBars/HPBar_" + red + ".png");
	...
	private void startGame(boolean load) {
		...
		changeHPBars(tank.getHpBlue(), tank.getHpRed());
//		for (int i = 0; i < btnLetters.length; i++) {
//			btnLetters[i].setOpaque(false);
//			btnLetters[i].setBackground(new Color(0, 0, 0, 0));
//			btnLetters[i].setEnabled(true);
//		}

		lblName.setText(String.format("%200s", tank.getPlayerName()));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == newGameItem) {
			...
			JOptionPane.showMessageDialog(this, "The game has been saved", "SAVE GAME", JOptionPane.INFORMATION_MESSAGE);
			saved = true;
