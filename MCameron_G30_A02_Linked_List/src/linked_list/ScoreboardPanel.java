			...
			for (int i = 0; i < cmbxPlayers.getItemCount(); i++) {
				if (scoreboard.getPlayer(i).getName() == cmbxPlayers.getSelectedItem())
					JOptionPane.showMessageDialog(null,
							new PlayerPanel(scoreboard.getPlayer(i).getName(), scoreboard.getPlayer(i).getGamesPlayed(),
									scoreboard.getPlayer(i).getGamesWon()),
							"Player Information", JOptionPane.PLAIN_MESSAGE);
			} // for loop
		} // if
	}// actionPerformed(ActionEvent)
}// ScoreboardPanel class